...
def segment_stardist(
    ...
    """Segment cells using StarDist algorithm with separate parameters for primary and cells.
    ...
    Args:
        ...
        stardist_kwargs: Additional keyword arguments for StarDist, including:
            - prob_threshold: Default probability threshold for both primary and cells
            - nms_threshold: Default NMS threshold for both primary and cells
        ...
        cells: Whether to segment both primary and cells or just primary
        reconcile: Method for reconciling primary and cells
        return_counts: Whether to return counts of primary and cells
...
def segment_stardist_multichannel(
    ...
    **kwargs,
    ...
    """Segment primary and cells using the StarDist algorithm with separate parameters.
...
def segment_stardist_primary(
    ...
    **kwargs,
    ...
    """Segment primary using the StarDist algorithm.
    ...
    # Segment primary with specified parameters
