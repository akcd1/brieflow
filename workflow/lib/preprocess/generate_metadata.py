"""Generate metadata CSV files for TIFF images.

This module provides functionality to create metadata CSV files from image metadata by
plate, well, and imaging round/cycle. The metadata includes dimensions, pixel size, and
